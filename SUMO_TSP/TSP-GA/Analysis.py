...
def analysis(file_name):
    ...
    for tripinfo in tripinfos:
        ...
        if rou == 'NW':
            ...
            bsndelay.append(tripinfo.getAttribute('timeLoss'))
        else:
            pass
    ...
    bsndelay = [float(x) for x in bsndelay]
    ...
    print('delay per bus(north through):', bnsmean)
    print('delay per bus(south through):', bsnmean)
    # print(delaylst)
